...
import icebergtracker.model.IcebergData;
...
public class IcebergTracker{
    ...
    public IcebergTracker() { 
        ...
        mapa.put(iceberg1, new IcebergData(LocalDate.of(2018, Month.MARCH, 1), iceberg1, "80º N 15' E", 9e9));
        mapa.put(iceberg1, new IcebergData(LocalDate.of(2018, Month.MARCH, 30), iceberg1, "80º N 12' E", 8e9));
        mapa.put(iceberg2, new IcebergData(LocalDate.of(2018, Month.MARCH, 1), iceberg2, "88º S 15' W", 7e9));
        mapa.put(iceberg2, new IcebergData(LocalDate.of(2018, Month.MARCH, 30), iceberg2, "88º S 30' W", 6e9));
    }
